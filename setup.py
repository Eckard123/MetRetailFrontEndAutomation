...
setup(
    name='MetRetailFrontEndAutomation',
    version='1.0',
    ...
    license='',
    author='EcBerry',
    author_email='eckard.berry@momentum.co.za',
    description='A program that creates new business policies on the metretail front end.', install_requires=['xlrd']
)
