...
scenario_source = "C:\\Projects\\Internal testing\\riskinternaltesting\\RiskInternalTesting-WEB\\src\\test\\resources\\Debug.xlsx"
new_tool = "C:\\Users\\EcBerry\\Desktop\\Myriad info\\Metropolitain\\VP\\Peter & Danelle pricing tools\\pk Alteration tool (20190301 onward).xlsb"
...
#    for off in (1, 5):
#        if value1 == value2:
#            workbook.cell(rowx=x-1, colx=Offset*off).__format__(format_spec=Color.rgb(GREEN))
#            print("Good job, they match")

            #_cell = openpyxl_utilities.Cell(worksheet="Sheet1", row=x-1, column=Offset*off)
...
tool_workbook = xlwings.Book(new_tool).sheets(3)
# Object to manipulate the pricing tool's calculations
xl_calc = xlwings.Book(new_tool)
# Object to write values to the scenario_source workbook
xl_write = xlwings.Book(scenario_source).sheets(1)
# Reading scenario lines
scenario_workbook = xlrd.open_workbook(scenario_source).sheet_by_index(0)
...
for x in range(7, 9):
    ...
    input.table_code_1 = scenario_workbook.cell(rowx=x-1, colx=14).value
    input.table_code_2 = scenario_workbook.cell(rowx=x-1, colx=52).value
    input.table_code_3 = scenario_workbook.cell(rowx=x-1, colx=90).value
    input.table_code_4 = scenario_workbook.cell(rowx=x-1, colx=128).value
    input.age = scenario_workbook.cell(rowx=x-1, colx=167).value
    input.dob = scenario_dob(Todays_date, input.age)
    input.sum_assured = scenario_workbook.cell(rowx=x-1, colx=31).value
    input.growth_Percentage = scenario_workbook.cell(rowx=x-1, colx=21).value
    input.package_code = str(scenario_workbook.cell(rowx=x-1, colx=26).value)
    ...
    if input.package_code == "801.0":
        input.scheme_code = "7005285"
    elif input.package_code == "802.0":
        input.scheme_code = "7005678"
    elif input.package_code == "803.0":
        input.scheme_code = "7005469"
    elif input.package_code == "804.0":
        input.scheme_code = "7005671"
    elif input.package_code == "805.0":
        input.scheme_code = "7005674"
    elif input.package_code == "806.0":
        input.scheme_code = "7005653"
    elif input.package_code == "807.0":
        input.scheme_code = "7005529"
    elif input.package_code == "808.0":
        input.scheme_code = "7005476"
    elif input.package_code == "809.0":
        input.scheme_code = "7005135"
    elif input.package_code == "810.0":
        input.scheme_code = "7005575"
    elif input.package_code == "811.0":
        input.scheme_code = "7005575"
    elif input.package_code == "812.0":
        input.scheme_code = "7005228"
    elif input.package_code == "813.0":
        input.scheme_code = "7005828"
    elif input.package_code == "814.0":
        input.scheme_code = "7005579"
    elif input.package_code == "815.0":
        input.scheme_code = "7005234"
    elif input.package_code == "816.0":
        input.scheme_code = "7005597"
    elif input.package_code == "817.0":
        input.scheme_code = "7005226"
    elif input.package_code == "818.0":
        input.scheme_code = "7001298"
    elif input.package_code == "819.0":
        input.scheme_code = "7005227"
    elif input.package_code == "820.0":
        input.scheme_code = "7005876"
    elif input.package_code == "841.0":
...
#_________________________________Now getting after VP elements for each benefit and also total prem after VP for each benefit__________
    ...
    output.main_tot_after_VP = tool_workbook.cells(4, 350).value

    if input.table_code_2 == "PUDT":
        output.second_tot_after_VP = tool_workbook.cells(4, 363).value
    elif input.table_code_2 == "PUDS":
        output.second_tot_after_VP = tool_workbook.cells(4, 376).value
    elif input.table_code_2 == "PURE":
        output.second_tot_after_VP = tool_workbook.cells(4, 389).value
    elif input.table_code_2 == "PURO":
        output.second_tot_after_VP = tool_workbook.cells(4, 389).value
    else:
    ...
    if input.table_code_3 == "PUDT":
        output.third_tot_after_VP = tool_workbook.cells(4, 363).value
    elif input.table_code_3 == "PUDS":
        output.third_tot_after_VP = tool_workbook.cells(4, 376).value
    elif input.table_code_3 == "PURE":
        output.third_tot_after_VP = tool_workbook.cells(4, 389).value
    elif input.table_code_3 == "PURO":
        output.third_tot_after_VP = tool_workbook.cells(4, 389).value
    else:
    ...
    if input.table_code_4 == "PUDT":
        output.fourth_tot_after_VP = tool_workbook.cells(4, 363).value
    elif input.table_code_4 == "PUDS":
        output.fourth_tot_after_VP = tool_workbook.cells(4, 376).value
    elif input.table_code_4 == "PURE":
        output.fourth_tot_after_VP = tool_workbook.cells(4, 389).value
    elif input.table_code_4 == "PURO":
        output.fourth_tot_after_VP = tool_workbook.cells(4, 389).value
    else:
    ...
    output.ProfitMarginPremAfterVP_Main = tool_workbook.cells(4, 351).value
    output.CleanRiskPremiumAfterVP_Main = tool_workbook.cells(4, 353).value
    output.initFixedPFeeAfterVP_Main = tool_workbook.cells(4, 354).value
    output.renewalFixedPFeeAfterVP_Main = tool_workbook.cells(4, 355).value
    output.claimsExpPremiumAfterVP_Main = tool_workbook.cells(4, 356).value
    output.renewalVariPFeeAfterVP_Main = tool_workbook.cells(4, 357).value
    output.DisribChannelSalesAfterVP_Main = tool_workbook.cells(4, 358).value
    output.InterAWSaleAfterVP_Main = tool_workbook.cells(4, 359).value
    output.InterUFSaleAfterVP_Main = tool_workbook.cells(4, 360).value
    output.InterUFLapseAfterVP_Main = tool_workbook.cells(4, 361).value
    output.LapseRiskOnExpAfterVP_Main = tool_workbook.cells(4, 362).value
    ...
    if input.table_code_2 == "PUDT":
        output.ProfitMarginPremAfterVP_Second = tool_workbook.cells(4, 364).value
        output.CleanRiskPremiumAfterVP_Second = tool_workbook.cells(4, 366).value
        output.initFixedPFeeAfterVP_Second = tool_workbook.cells(4, 367).value
        output.renewalFixedPFeeAfterVP_Second = tool_workbook.cells(4, 368).value
        output.claimsExpPremiumAfterVP_Second = tool_workbook.cells(4, 369).value
        output.renewalVariPFeeAfterVP_Second = tool_workbook.cells(4, 370).value
        output.DisribChannelSalesAfterVP_Second = tool_workbook.cells(4, 371).value
        output.InterAWSaleAfterVP_Second = tool_workbook.cells(4, 372).value
        output.InterUFSaleAfterVP_Second = tool_workbook.cells(4, 373).value
        output.InterUFLapseAfterVP_Second = tool_workbook.cells(4, 374).value
        output.LapseRiskOnExpAfterVP_Second = tool_workbook.cells(4, 375).value
    ...
    # Elements for the 'PUDS' benefit after VP
        ...
        output.ProfitMarginPremAfterVP_Second = tool_workbook.cells(4, 377).value
        output.CleanRiskPremiumAfterVP_Second = tool_workbook.cells(4, 379).value
        output.initFixedPFeeAfterVP_Second = tool_workbook.cells(4, 380).value
        output.renewalFixedPFeeAfterVP_Second = tool_workbook.cells(4, 381).value
        output.claimsExpPremiumAfterVP_Second = tool_workbook.cells(4, 382).value
        output.renewalVariPFeeAfterVP_Second = tool_workbook.cells(4, 383).value
        output.DisribChannelSalesAfterVP_Second = tool_workbook.cells(4, 384).value
        output.InterAWSaleAfterVP_Second = tool_workbook.cells(4, 385).value
        output.InterUFSaleAfterVP_Second = tool_workbook.cells(4, 386).value
        output.InterUFLapseAfterVP_Second = tool_workbook.cells(4, 387).value
        output.LapseRiskOnExpAfterVP_Second = tool_workbook.cells(4, 388).value
    ...
    # Elements for the 'PURE/PURO' benefit after VP
        ...
        output.ProfitMarginPremAfterVP_Second = tool_workbook.cells(4, 390).value
        output.CleanRiskPremiumAfterVP_Second = tool_workbook.cells(4, 392).value
        output.initFixedPFeeAfterVP_Second = tool_workbook.cells(4, 393).value
        output.renewalFixedPFeeAfterVP_Second = tool_workbook.cells(4, 394).value
        output.claimsExpPremiumAfterVP_Second = tool_workbook.cells(4, 395).value
        output.renewalVariPFeeAfterVP_Second = tool_workbook.cells(4, 396).value
        output.DisribChannelSalesAfterVP_Second = tool_workbook.cells(4, 397).value
        output.InterAWSaleAfterVP_Second = tool_workbook.cells(4, 398).value
        output.InterUFSaleAfterVP_Second = tool_workbook.cells(4, 399).value
        output.InterUFLapseAfterVP_Second = tool_workbook.cells(4, 400).value
        output.LapseRiskOnExpAfterVP_Second = tool_workbook.cells(4, 401).value
    ...
    if input.table_code_3 == "PUDT":
        output.ProfitMarginPremAfterVP_Third = tool_workbook.cells(4, 364).value
        output.CleanRiskPremiumAfterVP_Third = tool_workbook.cells(4, 366).value
        output.initFixedPFeeAfterVP_Third = tool_workbook.cells(4, 367).value
        output.renewalFixedPFeeAfterVP_Third = tool_workbook.cells(4, 368).value
        output.claimsExpPremiumAfterVP_Third = tool_workbook.cells(4, 369).value
        output.renewalVariPFeeAfterVP_Third = tool_workbook.cells(4, 370).value
        output.DisribChannelSalesAfterVP_Third = tool_workbook.cells(4, 371).value
        output.InterAWSaleAfterVP_Third = tool_workbook.cells(4, 372).value
        output.InterUFSaleAfterVP_Third = tool_workbook.cells(4, 373).value
        output.InterUFLapseAfterVP_Third = tool_workbook.cells(4, 374).value
        output.LapseRiskOnExpAfterVP_Third = tool_workbook.cells(4, 375).value
        ...
        output.ProfitMarginPremAfterVP_Third = tool_workbook.cells(4, 377).value
        output.CleanRiskPremiumAfterVP_Third = tool_workbook.cells(4, 379).value
        output.initFixedPFeeAfterVP_Third = tool_workbook.cells(4, 380).value
        output.renewalFixedPFeeAfterVP_Third = tool_workbook.cells(4, 381).value
        output.claimsExpPremiumAfterVP_Third = tool_workbook.cells(4, 382).value
        output.renewalVariPFeeAfterVP_Third = tool_workbook.cells(4, 383).value
        output.DisribChannelSalesAfterVP_Third = tool_workbook.cells(4, 384).value
        output.InterAWSaleAfterVP_Third = tool_workbook.cells(4, 385).value
        output.InterUFSaleAfterVP_Third = tool_workbook.cells(4, 386).value
        output.InterUFLapseAfterVP_Third = tool_workbook.cells(4, 387).value
        output.LapseRiskOnExpAfterVP_Third = tool_workbook.cells(4, 388).value
        ...
        output.ProfitMarginPremAfterVP_Third = tool_workbook.cells(4, 390).value
        output.CleanRiskPremiumAfterVP_Third = tool_workbook.cells(4, 392).value
        output.initFixedPFeeAfterVP_Third = tool_workbook.cells(4, 393).value
        output.renewalFixedPFeeAfterVP_Third = tool_workbook.cells(4, 394).value
        output.claimsExpPremiumAfterVP_Third = tool_workbook.cells(4, 395).value
        output.renewalVariPFeeAfterVP_Third = tool_workbook.cells(4, 396).value
        output.DisribChannelSalesAfterVP_Third = tool_workbook.cells(4, 397).value
        output.InterAWSaleAfterVP_Third = tool_workbook.cells(4, 398).value
        output.InterUFSaleAfterVP_Third = tool_workbook.cells(4, 399).value
        output.InterUFLapseAfterVP_Third = tool_workbook.cells(4, 400).value
        output.LapseRiskOnExpAfterVP_Third = tool_workbook.cells(4, 401).value
    ...
    if input.table_code_4 == "PUDT":
        output.ProfitMarginPremAfterVP_Fourth = tool_workbook.cells(4, 364).value
        output.CleanRiskPremiumAfterVP_Fourth = tool_workbook.cells(4, 366).value
        output.initFixedPFeeAfterVP_Fourth = tool_workbook.cells(4, 367).value
        output.renewalFixedPFeeAfterVP_Fourth = tool_workbook.cells(4, 368).value
        output.claimsExpPremiumAfterVP_Fourth = tool_workbook.cells(4, 369).value
        output.renewalVariPFeeAfterVP_Fourth = tool_workbook.cells(4, 370).value
        output.DisribChannelSalesAfterVP_Fourth = tool_workbook.cells(4, 371).value
        output.InterAWSaleAfterVP_Fourth = tool_workbook.cells(4, 372).value
        output.InterUFSaleAfterVP_Fourth = tool_workbook.cells(4, 373).value
        output.InterUFLapseAfterVP_Fourth = tool_workbook.cells(4, 374).value
        output.LapseRiskOnExpAfterVP_Fourth = tool_workbook.cells(4, 375).value
        ...
        output.ProfitMarginPremAfterVP_Fourth = tool_workbook.cells(4, 377).value
        output.CleanRiskPremiumAfterVP_Fourth = tool_workbook.cells(4, 379).value
        output.initFixedPFeeAfterVP_Fourth = tool_workbook.cells(4, 380).value
        output.renewalFixedPFeeAfterVP_Fourth = tool_workbook.cells(4, 381).value
        output.claimsExpPremiumAfterVP_Fourth = tool_workbook.cells(4, 382).value
        output.renewalVariPFeeAfterVP_Fourth = tool_workbook.cells(4, 383).value
        output.DisribChannelSalesAfterVP_Fourth = tool_workbook.cells(4, 384).value
        output.InterAWSaleAfterVP_Fourth = tool_workbook.cells(4, 385).value
        output.InterUFSaleAfterVP_Fourth = tool_workbook.cells(4, 386).value
        output.InterUFLapseAfterVP_Fourth = tool_workbook.cells(4, 387).value
        output.LapseRiskOnExpAfterVP_Fourth = tool_workbook.cells(4, 388).value
        ...
        output.ProfitMarginPremAfterVP_Fourth = tool_workbook.cells(4, 390).value
        output.CleanRiskPremiumAfterVP_Fourth = tool_workbook.cells(4, 392).value
        output.initFixedPFeeAfterVP_Fourth = tool_workbook.cells(4, 393).value
        output.renewalFixedPFeeAfterVP_Fourth = tool_workbook.cells(4, 394).value
        output.claimsExpPremiumAfterVP_Fourth = tool_workbook.cells(4, 395).value
        output.renewalVariPFeeAfterVP_Fourth = tool_workbook.cells(4, 396).value
        output.DisribChannelSalesAfterVP_Fourth = tool_workbook.cells(4, 397).value
        output.InterAWSaleAfterVP_Fourth = tool_workbook.cells(4, 398).value
        output.InterUFSaleAfterVP_Fourth = tool_workbook.cells(4, 399).value
        output.InterUFLapseAfterVP_Fourth = tool_workbook.cells(4, 400).value
        output.LapseRiskOnExpAfterVP_Fourth = tool_workbook.cells(4, 401).value
